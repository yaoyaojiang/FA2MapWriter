...
class StartFrame extends JFrame {
    ...
    private JButton newunits=new JButton("批量新增换皮单位");
    private JButton newactions=new JButton("批量新增行为（新）");
    ...
    public StartFrame()
    {
        ...
        newunits.setBounds(230,60,170,30);
        newactions.setBounds(230,100,170,30);
        addListener();
        panel.add(troops);
        panel.add(scripts);
        panel.add(teamtypes);
    ...
    void addListener()
    {
        ...
        newunits.addMouseListener(new MouseAdapter() {
            @Override
            public void mouseClicked(MouseEvent e) {
                NewUnits mj= null;
                try {
     ...
     /*    newactions.addMouseListener(new MouseAdapter() {
            @Override
            public void mouseClicked(MouseEvent e) {
                CreateActions mj= null;
                mj = new CreateActions();
                mj.setDefaultCloseOperation(HIDE_ON_CLOSE);
                mj.setVisible(true);
            }
        });*/
