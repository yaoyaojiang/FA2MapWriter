...
public class mapList {
    ...
    public String getUsingSPYPHouse() {
        return UsingSPYPHouse;
    }

    public void setUsingSPYPHouse(String usingSPYPHouse) {
        UsingSPYPHouse = usingSPYPHouse;
    }
    ...
    public void addVariableNames(String s)
    {
